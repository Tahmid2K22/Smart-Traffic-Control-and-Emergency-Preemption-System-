...
class _NearbyPlacesPageState extends State<NearbyPlacesPage> {
  ...
  List<_Place> get _places => widget.type == NearbyPlaceType.hospitals ? _hospitals : _pharmacies;
...
class _Place {
  const _Place(this.name, this.address, this.distanceKm, this.isOpen, this.icon);
  final String name;
